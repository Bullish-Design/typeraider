...
from aider import urls, models, utils, __version__
from aider.repo import GitRepo, ANY_GIT_ERROR
from aider.format_settings import format_settings, scrub_sensitive_info

from .log.logger import get_logger

logger = get_logger("Init_Utils")
...
# def scrub_sensitive_info(args, cmd_line):
#     # ... (function to scrub sensitive info from command line)
#     pass
